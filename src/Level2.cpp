...
void Level2::StartUp(SDL_Renderer* renderer){
...
void Level2::Input(float deltaTime){
...
void Level2::SetSceneActive(bool status){
    isActive = status;
}

bool Level2::IsSceneActive(){return isActive;}

int Level2::GetNextScene(){return nextScene;}