...
void Level3::StartUp(SDL_Renderer* renderer){
...
void Level3::Input(float deltaTime){
...
void Level3::SetSceneActive(bool status){
    isActive = status;
}

bool Level3::IsSceneActive(){return isActive;}

int Level3::GetNextScene(){return nextScene;}